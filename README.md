...
v. 0.72
- Добавлены алерты для регистрации и авторизации
- Проверки для авторизации и регистрации
- Доработана локализация

v. 0.73
- Добавлен календарик для выбора даты дедлайна
- Исправлен баг в планах при обновлении задач

v. 0.74
- Выбор .exe файла с помощью окна
